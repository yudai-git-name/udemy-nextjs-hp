...
const navigationMenu = [
  ...
  { href: '#Solutions', label: 'ソリューションズ' },
  { href: '#Testimonials', label: 'カスタマー' },
  { href: '#blog', label: 'ブログ・ニュース' },
];
                ...
                {navigationMenu.map((item, index) => (
                  <li key={index}>
                    ...
                    >
                      ...
                      <span className="relative left-2 duration-300 transition-all ease-out opacity-0 group-hover:opacity-100 group-hover:left-3">
