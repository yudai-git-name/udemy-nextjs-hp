...
const heroContents = {
  text: {
    ...
    title: 'ひとつを目指せる',
    description:
      'ようこそ！未来にために、共に学び、成長しましょう。ORIGIN.Docゼミでは、生徒ひとりに合わせたカリキュラムで、確かな学力向上を目指します。私たちは教育のプロフェッショナルが揃い、生徒たちが自信を持ち、自ら考え、進んで学ぶ力を身につけられるようにサポートしています。',
  },
  images: {
          ...
          <div className="lg:w-6/12 space-y-2">
            <div className="flex space-x-2 items-stretch">
              ...
              <div className="w-4/12 self-end space-y-2">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="bg-purpleLight rounded-2xl rounded-tr-[200px]"></div>
                </div>
                <div>
                  <Image
                    src={heroContents.images.img3}
                    width={374}
                    height={392}
                    alt="img3"
                    className="object-cover h-full w-full rounded-2xl"
            ...
            <div className="flex space-x-2">
              <div className="w-4/12">
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-yellowLight rounded-2xl rounded-bl-[200px]"></div>
                  <Image
                    src={heroContents.images.img4}
                    width={394}
                    height={394}
                    alt="img4"
                    className="object-cover h-full w-full rounded-2xl"
